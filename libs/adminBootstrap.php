...
class adminBootstrap {
    ...
    private function _loadDefaultController() {
        require ADMIN_DIR . $this->_controllerPath . $this->_defaultFile;
        $this->_controller = new login();
        $this->_controller->index();
    }

    private function _loadController() {
        $file = ADMIN_DIR . $this->_controllerPath . $this->_url[0] . '.php';
        if (file_exists($file)) {
            require $file;
    ...
    private function _error() {
        require ADMIN_DIR . $this->_controllerPath . $this->_errorFile;
