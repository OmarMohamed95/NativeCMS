<div class="pageCon">
    <h1 class="alert alert-info pageH">Edit page</h1>
    <div class="col-xs-offset-1">
        <form action="<?php echo ADMIN_URL; ?>page/update/<?php echo $this->getSingle['id']; ?>" method="POST"  enctype="multipart/form-data">
